    ...
    <div className="min-h-[100vh] px-4 pt-24 bg-obsidian-deep text-on-surface">
      ...
      <div className="mx-auto w-full max-w-md rounded-3xl border border-border-highlight bg-surface-container p-10 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="rounded-3xl bg-primary/10 border border-primary/20 px-4 py-3">
            <p className="text-xs font-semibold text-primary mb-2">Demo Credentials:</p>
            <p className="text-xs text-primary/80"><strong>Email:</strong> {DUMMY_EMAIL}</p>
            <p className="text-xs text-primary/80"><strong>Password:</strong> {DUMMY_PASSWORD}</p>
          </div>

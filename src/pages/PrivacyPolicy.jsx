        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="rounded-xl border border-primary/30 bg-primary/5 p-5 mb-10 flex items-start gap-4">
            ...
            <p className="font-body text-sm text-on-surface-variant leading-relaxed">
              Your privacy matters to us. We collect only the information necessary to deliver
              our services and never sell your data to third parties. This policy is written in
              plain language so you can understand exactly how your data is used.
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-body text-sm text-on-surface-variant leading-relaxed mb-4">
                  For data requests, privacy concerns, or to exercise your rights under UAE
                  data protection law, please contact us:
                </p>
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    { icon: 'schedule', text: 'Response within 5 business days' },
                  ].map(({ icon, text }) => (
